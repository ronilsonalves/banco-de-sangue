...
export default function FormEdit({candidatoValue}) {
  ...
  useEffect(() => {
    let defaultValues = {};
    defaultValues.nome = candidatoValue.nome
    defaultValues.cpf = candidatoValue.cpf
    defaultValues.rg = candidatoValue.rg
    defaultValues.sexo = candidatoValue.sexo
    defaultValues.data_nasc = `${candidatoValue.data_nasc[0]}-${candidatoValue.data_nasc[1]}-${candidatoValue.data_nasc[2]}`
    defaultValues.mae = candidatoValue.mae
    defaultValues.pai = candidatoValue.pai
    defaultValues.email = candidatoValue.email
    defaultValues.telefone_fixo = candidatoValue.telefone_fixo
    defaultValues.celular = candidatoValue.celular
    defaultValues.endereco = candidatoValue.endereco
    defaultValues.numero = candidatoValue.numero
    defaultValues.bairro = candidatoValue.bairro
    defaultValues.cidade = candidatoValue.cidade
    defaultValues.estado = candidatoValue.estado
    defaultValues.cep = candidatoValue.cep
    defaultValues.tipo_sanguineo = candidatoValue.tipo_sanguineo
    defaultValues.peso = candidatoValue.peso
    defaultValues.altura = candidatoValue.altura
    reset({...defaultValues})
  },[])
  ...
  const handleRegistration = async (data) => {
    ...
    try {
      const response = await axios.put(
        `http://localhost:8080/candidatos/${candidatoValue.id}`,
        dataPost
      )
      setStatus('SUCCESS')
      console.log(response)
      handleResponse(data)
      candidatoValue = dataPost
      reset(null)
    } catch (error) {
      setStatus('ERROR')
      handleResponse(data)
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-green-800">
                Candidato(a) atualizado com sucesso!
              </h3>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-red-800">
                Erro ao atualizar candidato(a)
              </h3>
              <div className="mt-2 text-sm text-red-700">
                <p>
                  Ocorreu um erro ao tentar atualizar o candidato(a) no sistema.
                </p>
              </div>
            </div>
          </div>
      ...
      return (
        <div className="my-4 rounded-md bg-red-50 p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-red-800">
                Candidato(a) excluído(a) com sucesso!
              </h3>
              <div className="mt-2 text-sm text-red-700">
                <p>
                  O candidato(a) foi excluído(a) com sucesso do sistema.
                </p>
              </div>
            </div>
            <button onClick={() => router.push('/candidatos')}>Voltar aos candidatos</button>
          </div>
        </div>
      )
    }
    ...
    <div className="flex flex-col flex-wrap">
      ...
      >
        <h1 className="text-2xl font-bold">
          Editar dados do(a) candidato: {candidatoValue.nome}
        </h1>
